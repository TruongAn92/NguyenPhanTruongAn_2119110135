...
namespace MVC_Basic.Areas.Admin.Controllers
{
    public class UserController : Controller
    {
        ...
        {
            var lstUser = new List<User_2119110135>();
            ...
            {
                lstUser = objwebSiteBanHangEntities.User_2119110135.Where(n => n.FirstName.Contains(SearchString)).ToList();
            }
            else
            {
        ...
        {
            var User = objwebSiteBanHangEntities.User_2119110135.Where(n => n.Id == id).FirstOrDefault();
            return View(User);
        }
        ...
        [HttpPost]
        public ActionResult Delete(User_2119110135 objPro)
        {
            var objUser = objwebSiteBanHangEntities.User_2119110135.Where(n => n.Id == objPro.Id).FirstOrDefault();
            objwebSiteBanHangEntities.User_2119110135.Remove(objUser);
        ...
        {
            Common objCommon = new Common();
            var lstUser = objwebSiteBanHangEntities.User_2119110135.ToList();
            ListtoDataTableConverter converter = new ListtoDataTableConverter();
            DataTable dtUser = converter.ToDataTable(lstUser);
            ViewBag.ListUser = objCommon.ToSelectList(dtUser, "Id", "IsAdmin");
        ...
        public ActionResult Edit(int id, User_2119110135 objUser)
        {
