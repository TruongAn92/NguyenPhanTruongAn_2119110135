...
namespace MVC_Basic.Areas.Admin.Controllers
{
    public class CategoryController : Controller
    {
        ...
        {
            var lstCategory = new List<Category_2119110135>();
            ...
            {
                lstCategory = objwebSiteBanHangEntities.Category_2119110135.Where(n => n.Name.Contains(SearchString)).ToList();
            }
            else
            {
                lstCategory = objwebSiteBanHangEntities.Category_2119110135.ToList();
            }
        ...
        {
            var product = objwebSiteBanHangEntities.Category_2119110135.Where(n => n.Id == id).FirstOrDefault();
            return View(product);
        }
        ...
        [HttpPost]
        public ActionResult Delete(Category_2119110135 objCat)
        {
            var objCategory = objwebSiteBanHangEntities.Category_2119110135.Where(n => n.Id == objCat.Id).FirstOrDefault();
            objwebSiteBanHangEntities.Category_2119110135.Remove(objCategory);
        ...
        [ValidateInput(false)]
        [HttpPost]
        public ActionResult Create(Category_2119110135 category)
        {
            this.LoadData();
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    objwebSiteBanHangEntities.Category_2119110135.Add(category);
                    objwebSiteBanHangEntities.SaveChanges();
        ...
        public ActionResult Edit(int id)
        {
            ...
            var category = objwebSiteBanHangEntities.Category_2119110135.Where(n => n.Id == id).FirstOrDefault();
            return View(category);
        }

        [HttpPost, ValidateInput(false)]
        public ActionResult Edit(int id, Category_2119110135 objCategory)
        {
